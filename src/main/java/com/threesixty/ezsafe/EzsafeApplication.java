...
public class EzsafeApplication {
	...
	private void initialize() {
		...
		newDeviceBtn.setBounds(275, 224, 279, 29);
		panel_1.add(newDeviceBtn);
		
		JButton btnDeactivateDevice = new JButton("Deactivate Device");
		...
		btnDeactivateDevice.setBounds(574, 224, 279, 29);
    ...
    /**
     * Method for creating an device ID for a device.
     */
